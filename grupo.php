...
<main>
    ...
    <h5>Revisa la información de todo tu grupo Origen:</h5>
    ...
    if ($resultGrupo) {
        ...
        if ($resultGrupo->num_rows > 0) {
            ...
            <div class='table-responsive contenedor-tablas my-5 mx-1 border rounded-3'>
                <table id='tablaGrupo' class='table table-bordered table-responsive-sm table-hover text-center align-middle mh-100'>
                    <thead>
